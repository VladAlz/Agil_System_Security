try {
    ...
    Write-Host "Sending POST /api/alerts..."
    $alertResp = Invoke-WebRequest -Uri "http://localhost:5000/api/alerts" -Method Post -ContentType "application/json" -Headers $headers -Body $alertBody
