...
import { GuardLeafletWebView } from '../components/GuardLeafletWebView';
  ...
  const loadCurrentLocation = async () => {
    try {
      ...
      const currentPosition = await Location.getCurrentPositionAsync({
        accuracy: Location.Accuracy.BestForNavigation,   // HU-15: máxima precisión GPS
      });
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.mapContainer}>
        {loading ? (
          ...
          // HU-13/HU-15: mapa Leaflet en WebView (satélite + calles + POIs, sin API key)
          <GuardLeafletWebView lat={latitude} lng={longitude} />
        )}
